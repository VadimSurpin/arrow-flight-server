 ...
 *
 * Использование:
 *   spark-submit --class server.pro.surpin.data.arrowflight.debug.DataGenerator <jar> <num_rows> <output_path> <num_partitions>
 *   Пример: spark-submit --class server.pro.surpin.data.arrowflight.debug.DataGenerator target/hadoop-arrow-flight.jar 10000000000 hdfs:///data/vsurpin/test_db/test_1tb_table 2000
 */
